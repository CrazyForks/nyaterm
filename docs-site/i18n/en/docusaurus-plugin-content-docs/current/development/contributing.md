...
2. Check the [Issues](https://git.coderkang.top/Tauri/dragonfly/issues) list
...
Contributions are licensed under the project's [MIT License](https://git.coderkang.top/Tauri/dragonfly/blob/main/LICENSE).
